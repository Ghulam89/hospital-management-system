...
const AddStockReturn = ({ 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...formData,
        pharmRackId: formData.pharmRackId?._id || formData.pharmRackId,
        pharmManufacturerId: formData.pharmManufacturerId?._id || formData.pharmManufacturerId,
        pharmSupplierId: formData.pharmSupplierId?._id || formData.pharmSupplierId,
        pharmCategoryId: formData.pharmCategoryId?._id || formData.pharmCategoryId
      };
