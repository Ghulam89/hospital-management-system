...
const AddPharmacyCategories = ({ isModalOpen, setIsModalOpen, selectedCategory, fetchExpenseCategories }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const request = selectedCategory
        ? axios.put(`${Base_url}/apis/pharmCategory/update/${selectedCategory._id}`, formData)
        : axios.post(`${Base_url}/apis/pharmCategory/create`, formData);
...
export default AddPharmacyCategories;