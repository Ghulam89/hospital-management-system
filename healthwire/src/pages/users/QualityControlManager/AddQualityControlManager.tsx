...
const AddQualityControlManager = () => {
  ...
  const [roleKey, setRoleKey] = useState('quality_control_manager');
      ...
      axios
        ...
        .then((res) => {
          if (res.data.status === 'ok') {
            toast.success('Quality control manager registered successfully!');
  ...
  return (
    <>
      <Breadcrumb pageName="Add Quality Control Manager" />

      <div className="">
        <div className="flex flex-col gap-9">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
              <h3 className="font-medium text-black dark:text-white">Add Quality Control Manager</h3>
            </div>
...
export default AddQualityControlManager;
