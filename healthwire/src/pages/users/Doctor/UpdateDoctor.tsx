...
const UpdateDoctor = () => {
  ...
  const fetchDoctorData = useCallback(async () => {
    try {
      ...
      setState({
        ...
        registrations: doctorData.registrations || '',
        memberShip: doctorData.memberShip || '',
        language: doctorData.language || '',
        experience: doctorData.experience || '',
        degreeCompletionDate: doctorData.degreeCompletionDate || '',
        PMDC: doctorData.PMDC || '',
        consultationFee: doctorData.consultationFee || '',
        followUpCharges: doctorData.followUpCharges || '',
        sharePrice: doctorData.sharePrice || '',
        shareType: doctorData.shareType || 'Rupees',
      });
      ...
      if (doctorData.qualification && doctorData.qualification.length > 0) {
        setQualifications(doctorData.qualification);
      }
      ...
      // Set availability
      setAvailability({
        monday: doctorData.monday || doctorData?.monday || null,
        mondayStartTime:
          doctorData.mondayStartTime || doctorData?.mondayStartTime || '',
        mondayEndTime:
          doctorData.mondayEndTime || doctorData?.mondayEndTime || '',
        mondayDuration:
          doctorData.mondayDuration || doctorData?.mondayDuration || '',
        tuesday: doctorData.tuesday || doctorData?.tuesday || null,
        tuesdayStartTime:
          doctorData.tuesdayStartTime || doctorData?.tuesdayStartTime || '',
        tuesdayEndTime:
          doctorData.tuesdayEndTime || doctorData?.tuesdayEndTime || '',
        tuesdayDuration:
          doctorData.tuesdayDuration || doctorData?.tuesdayDuration || '',
        wednesday: doctorData.wednesday || doctorData.wednesday || null,
        wednesdayStartTime:
          doctorData.wednesdayStartTime || doctorData.wednesdayStartTime || '',
        wednesdayEndTime:
          doctorData.wednesdayEndTime || doctorData.wednesdayEndTime || '',
        wednesdayDuration:
          doctorData.wednesdayDuration || doctorData.wednesdayDuration || '',
        thursday: doctorData.thursday || doctorData.thursday || null,
        thursdayStartTime:
          doctorData.thursdayStartTime || doctorData.thursdayStartTime || '',
        thursdayEndTime:
          doctorData.thursdayEndTime || doctorData.thursdayEndTime || '',
        thursdayDuration:
          doctorData.thursdayDuration || doctorData.thursdayDuration || '',
        friday: doctorData.friday || doctorData.friday || null,
        fridayStartTime:
          doctorData.fridayStartTime || doctorData.fridayStartTime || '',
        fridayEndTime:
          doctorData.fridayEndTime || doctorData.fridayEndTime || '',
        fridayDuration:
          doctorData.fridayDuration || doctorData.fridayDuration || '',
        saturday: doctorData.saturday || doctorData.saturday || null,
        saturdayStartTime:
          doctorData.saturdayStartTime || doctorData.saturdayStartTime || '',
        saturdayEndTime:
          doctorData.saturdayEndTime || doctorData.saturdayEndTime || '',
        saturdayDuration:
          doctorData.saturdayDuration || doctorData.saturdayDuration || '',
        sunday: doctorData.sunday || doctorData.sunday || null,
        sundayStartTime:
          doctorData.sundayStartTime || doctorData.sundayStartTime || '',
        sundayEndTime:
          doctorData.sundayEndTime || doctorData.sundayEndTime || '',
        sundayDuration:
  ...
  const fetchDepartments = useCallback(() => {
    axios
      .get('https://api.holisticare.pk/apis/department/get')
      .then((res) => {
  ...
  useEffect(() => {
    fetchDoctorData();
    fetchDepartments();
  }, [fetchDoctorData, fetchDepartments]);

  // Input handlers (keep all your existing handlers)
  ...
  const handleChange = (e) => {
    ...
    if (type === 'checkbox' && name in availability) {
      ...
      const newAvailability = {
        ...availability,
        [name]: checked,
        [`${dayPrefix}StartTime`]: checked
          ? '09:00'
          : availability[`${dayPrefix}StartTime`],
        [`${dayPrefix}EndTime`]: checked
          ? '17:00'
          : availability[`${dayPrefix}EndTime`],
        [`${dayPrefix}Duration`]: checked
          ? '30'
          : availability[`${dayPrefix}Duration`],
      };
  ...
  const handleSubmit = async (e) => {
    ...
    const params = {
      ...
      phone: state.phone,
      email: state.email,
      password: state.password || undefined, // Only send password if it's changed
      shift: state.shift,
      ...
      PMDC: state.PMDC,
      qualification: qualifications.filter(
        (q) => q.degree && q.institute && q.year,
      ),
      services: services.filter((s) => s.name && s.description),
      monday: availability.monday,
      mondayStartTime: availability.mondayStartTime,
      mondayEndTime: availability.mondayEndTime,
      mondayDuration: availability.mondayDuration,
      tuesday: availability.tuesday,
      tuesdayStartTime: availability.tuesdayStartTime,
      tuesdayEndTime: availability.tuesdayEndTime,
      tuesdayDuration: availability.tuesdayDuration,
      wednesday: availability.wednesday,
      wednesdayStartTime: availability.wednesdayStartTime,
      wednesdayEndTime: availability.wednesdayEndTime,
      wednesdayDuration: availability.wednesdayDuration,
      thursday: availability.thursday,
      thursdayStartTime: availability.thursdayStartTime,
      thursdayEndTime: availability.thursdayEndTime,
      thursdayDuration: availability.thursdayDuration,
      friday: availability.friday,
      fridayStartTime: availability.fridayStartTime,
      fridayEndTime: availability.fridayEndTime,
      fridayDuration: availability.fridayDuration,
      saturday: availability.saturday,
      saturdayStartTime: availability.saturdayStartTime,
      saturdayEndTime: availability.saturdayEndTime,
      saturdayDuration: availability.saturdayDuration,
      sunday: availability.sunday,
      sundayStartTime: availability.sundayStartTime,
      sundayEndTime: availability.sundayEndTime,
  ...
  if (loading) {
    return (
      <>
        <Breadcrumb pageName="Update Doctor" />
            ...
            <div className="flex flex-col gap-9">
              <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div className="p-6.5">
                  ...
                  {/* Add these fields with your other form inputs */}
                  <div className="mb-4.5 grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Consultation Fee */}
                    {/* <div>
        <label className="mb-2.5 block text-black dark:text-white">
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-6.5">
                {qualifications.map((qual, index) => (
                  <div
                    key={index}
                    className="mb-6 border-b border-stroke pb-6 relative"
                  >
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-6.5">
                ...
                <div className="mt-4 text-sm text-gray-500">
                  <p>
                    Note: Duration is the time allocated per patient appointment
                    in minutes.
                  </p>
                </div>
              </div>
            ...
            >
              {isSubmitting ? (
                <>
                  ...
                  {activeTab === 'Timing' ? 'Updating...' : 'Processing...'}
                </>
              ) : activeTab === 'Timing' ? (
                'Update Doctor'
              ) : (
