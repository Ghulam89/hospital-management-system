      ...
      if(!state.name){
        ...
        axios.post('https://api.holisticare.pk/apis/user/create',params).then((res)=>{
          ...
          if(res.data.status==='ok'){
            toast.success("Nurse registration successfully!");
                      ...
                      <label className="flex cursor-pointer select-none items-center">
                        <div className="relative">
                          <input
                            ...
                            id="roleNurse"
                            className="sr-only"
                            checked={roleRights.nurse === 'nurse'}
                            onChange={() => handleRoleRightChange('nurse')}
                          />
                          <div
            className={`mr-4 flex h-5 w-5 items-center justify-center rounded border ${
              roleRights.nurse === 'nurse' ? 'border-primary bg-gray dark:bg-transparent' : ''
            }`}
          >
                            {roleRights.nurse === 'nurse' && (
                              <svg
                                width="11"
                                height="8"
                                viewBox="0 0 11 8"
                        ...
                        Nurse (Access to accounts and financial data)
                      </label>
                    </div>
                  </div>
