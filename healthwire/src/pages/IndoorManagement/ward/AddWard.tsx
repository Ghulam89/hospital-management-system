...
const AddWard = ({ isModalOpen, setIsModalOpen, selectedWard, fetchWardData }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const request = selectedWard
      ? axios.put(`https://api.holisticare.pk/apis/ward/update/${selectedWard._id}`, formData)
      : axios.post('https://api.holisticare.pk/apis/ward/create', formData);
    ...
    <div>
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="p-3.5 flex justify-between items-center">
          <h1 className="capitalize text-black h4 font-semibold text-xl">{selectedWard ? 'Edit Ward' : 'Add Ward'}</h1>
