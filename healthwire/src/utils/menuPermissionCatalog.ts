 ...
 * Keep in sync with health_hospital/utils/menuPermissionCatalog.js
 */
...
export const MENU_MATRIX_ACTIONS = ['module', 'create', 'read', 'update', 'delete'] as const;
export type MenuMatrixAction = (typeof MENU_MATRIX_ACTIONS)[number];

export const MENU_ROWS: MenuMatrixRow[] = [
  ...
  { id: 'ward', label: 'Wards', group: 'Indoor Management', parentLabel: 'Indoor Management', pathPrefix: '/ward', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'rooms', label: 'Rooms', group: 'Indoor Management', parentLabel: 'Indoor Management', pathPrefix: '/rooms', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'bed_details', label: 'Bed Details', group: 'Indoor Management', parentLabel: 'Indoor Management', pathPrefix: '/bed-details', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'room_details', label: 'Room Details', group: 'Indoor Management', parentLabel: 'Indoor Management', pathPrefix: '/room-details', cells: { module: true, create: true, read: true, update: true, delete: false } },
  ...
  { id: 'appointments', label: 'Appointments', group: 'Clinical', pathPrefix: '/appointments', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'invoices', label: 'Invoices', group: 'Clinical', pathPrefix: '/invoice', cells: { module: true, create: true, read: true, update: true, delete: false } },
  ...
  { id: 'pharm_items', label: 'Items', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/items/pharmacy', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'pharm_stock', label: 'Manage Stock', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/stocks', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'pharm_returns', label: 'Stock Return', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/stock_returns', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'pharm_po', label: 'Purchase Orders', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/purchase-orders', cells: { module: true, create: true, read: true, update: true, delete: false } },
  ...
  { id: 'pharm_expenses', label: 'Pharmacy Expenses', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/expenses', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'pharm_suppliers', label: 'Suppliers', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/supplier', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'pharm_pos', label: 'POS', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/invoices/new', cells: { module: true, create: true, read: true, update: true, delete: false } },
  ...
  { id: 'pharm_categories', label: 'Categories', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/categories', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'pharm_manufacturers', label: 'Manufacturers', group: 'Pharmacy', parentLabel: 'Pharmacy', pathPrefix: '/admin/pharmacy/manufacturers', cells: { module: true, create: true, read: true, update: true, delete: false } },
  ...
  { id: 'expense_categories', label: 'Expense Categories', group: 'Preferences', parentLabel: 'Preferences', pathPrefix: '/expense-categories', cells: { module: true, create: true, read: true, update: true, delete: false } },
  { id: 'expense', label: 'Expense', group: 'Preferences', parentLabel: 'Preferences', pathPrefix: '/expense', cells: { module: true, create: true, read: true, update: true, delete: false } },
  ...
  { id: 'users', label: 'Users', group: 'Administration', pathPrefix: '/admin/users', cells: { module: true, create: true, read: true, update: true, delete: false } },
...
export function menuPermissionKey(menuId: string, action: MenuMatrixAction): string {
  return `mp.${menuId}.${action}`;
}

export function flattenMenuPermissionKeys(): string[] {
  const keys: string[] = [];
  for (const row of MENU_ROWS) {
    for (const a of MENU_MATRIX_ACTIONS) {
      if (row.cells[a]) keys.push(menuPermissionKey(row.id, a));
    }
  }
  return keys;
}
